...
updated: 2026-03-01
type: garden
topic: AI tools, research workflows, Claude Code, NotebookLM
dg-publish: true
---
...
- Claude Code adds control over *which* sources go in (better signal-to-noise than NotebookLM's built-in "fast research")
