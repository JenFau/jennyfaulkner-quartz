...
Like MCP, A2A is based on client-server architecture, and the two models use similar underlying messages and transport protocols. https://www.theregister.com/2025/07/12/ai_agent_protocols_mcp_a2a/.
...
According to https://www.theregister.com/2025/07/12/ai_agent_protocols_mcp_a2a/, agents in a system essentially exchange business cards, containing information on what they can do, how to authenticate, their optional functionality and what kinds of formats they can ingest or return. This means they can send each other tasks, with one acting as the client and the other as the server. Notably, these roles need not be fixed - an agent can act as either a client or a server depending on the context.
