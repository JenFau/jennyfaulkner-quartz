...
interface CustomFolderPageOptions extends FullPageLayout {
...
export const CustomFolderPage: QuartzEmitterPlugin<Partial<CustomFolderPageOptions>> = (
  userOpts,
) => {
          ...
          return data.slug
            ? _getFolders(data.slug).filter(
                (folderName) =>
                  folderName !== "." &&
                  folderName !== "tags" &&
                  !skipFolders.includes(folderName),
              )
            : []
        }),
      )
